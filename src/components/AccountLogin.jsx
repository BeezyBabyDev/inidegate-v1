    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 max-w-md w-full border border-white/20">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-indigo-200 text-sm">Sign in to your {portalConfig.name}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {errors.submit && (
            <div className="text-red-400 text-center text-sm bg-red-400/10 p-3 rounded-lg border border-red-400/20">
              ...
              {(errors.submit.includes('403') ||
                errors.submit.includes('Database') ||
                errors.submit.includes('access denied')) && (
                <button
                  type="button"
        ...
        <div className="mt-6 p-4 bg-indigo-500/20 rounded-lg border border-indigo-400/30">
          <div className="text-center">
            ...
            <p className="text-indigo-300 text-xs mb-2">Try these demo credentials:</p>
      ...
      {/* Debug Panel */}
      {showDebugPanel && <AuthDebugPanel onClose={() => setShowDebugPanel(false)} />}
    </div>
  )
}
