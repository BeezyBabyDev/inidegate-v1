...
const InvestorHeader = ({ onBack, onLogout, onViewNetwork }) => {
    ...
    <header className="sticky top-0 z-50 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 bg-opacity-90 backdrop-blur-lg px-6 py-4 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-center items-center space-x-6">
          ...
          {/* My Network */}
          <button className="flex items-center space-x-2 text-white hover:text-blue-300 focus:outline-none" onClick={onViewNetwork}>
            {/* Network Icon */}
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
