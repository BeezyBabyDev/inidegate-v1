...
const WelcomePage = ({ onEnterCode, onShowAccountSystem, onShowFilmDemo, onGoToPortal }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          isAuthenticated && currentUser ? [
            React.createElement(
              'div',
              { key: 'welcome-back', className: 'mb-4 p-4 bg-green-500/20 rounded-lg border border-green-400/30' },
              React.createElement(
                'p',
      ...
      showAuthDemo && React.createElement(AuthDemo, {
